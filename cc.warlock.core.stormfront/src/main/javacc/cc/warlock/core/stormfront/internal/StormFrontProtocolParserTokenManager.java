/* Generated By:JavaCC: Do not edit this line. StormFrontProtocolParserTokenManager.java */
...
/** Token Manager. */
public class StormFrontProtocolParserTokenManager implements StormFrontProtocolParserConstants
{
         ...
         do
         {
            switch(jjstateSet[--i])
            {
               ...
               case 2:
                  ...
                  break;
               case 3:
                  if ((0x7ff600000000000L & l) != 0L && kind > 5)
                     kind = 5;
                  break;
               case 4:
         ...
         do
         {
            switch(jjstateSet[--i])
            {
               ...
               case 0:
                  ...
                  break;
               case 2:
                  if ((0xf800000178000001L & l) != 0L && kind > 4)
                     kind = 4;
                  break;
               case 3:
...
"", "\74", "\74\57", null, null, null, null, null, null, "\76", "\57\76", 
...
/** Constructor. */
public StormFrontProtocolParserTokenManager(SimpleCharStream stream){
...
/** Constructor. */
public StormFrontProtocolParserTokenManager(SimpleCharStream stream, int lexState){
   this(stream);
   SwitchTo(lexState);
}
   ...
   switch(jjmatchedKind)
   {
      case 1 :
        ...
        lengthOfMatch = jjstrLiteralImages[1].length();
                                tagBuffer.setLength(0); buffer(matchedToken.image);
         break;
      case 2 :
      ...
      case 3 :
        image.append(input_stream.GetSuffix(jjimageLen + (lengthOfMatch = jjmatchedPos + 1)));
                                                         buffer(matchedToken.image); matchedToken.image = matchedToken.image.substring(1, matchedToken.image.length() - 1);
         break;
      case 4 :
        image.append(input_stream.GetSuffix(jjimageLen + (lengthOfMatch = jjmatchedPos + 1)));
                                                                            buffer(matchedToken.image);
         break;
      case 9 :
